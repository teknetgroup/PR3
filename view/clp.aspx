...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body class="body2">
        <form id="form1" runat="server">
            ...
            <asp:Panel ID="Panel3" runat="server" Style="margin-left: 25%; margin-top: 7%" Width="657px">
            ...
            <asp:Panel ID="Panel4" runat="server" Height="5px">
                <div class="msbt">
                    <table>
                        <tr>
                            ...
                            <td class="auto-style26">
                                <asp:Label ID="Label4" runat="server" class="btn btn-primary " Visible="false">
                                    ...
                                    <asp:FileUpload ID="FU1" runat="server" Class="file" data-icon="false" onchange="UploadFile(this);" Visible="false" />
                                </asp:Label></td>
                            <td class="auto-style26">
            ...
            <asp:Panel ID="Panel1" runat="server" Height="482px" Width="400px">
                <table class="auto-style4">
                    <tr>
                        <td class="radio1">
                            <asp:RadioButton ID="Rad1" runat="server" OnCheckedChanged="Rad1_CheckedChanged" Text="Texte" AutoPostBack="true" GroupName="measurementSystem" />
                        </td>
                        <td class="radio2">
            ...
            <div id="rectangle" class="form-control">
                ...
                </a><a id="plusBtn" onclick="plus()" style="cursor: pointer;">
            ...
            <asp:Panel ID="Panel" runat="server">
                <table class="resultat">
                    <tr>
                        <td>
                            <asp:Button class=" btn btn-primary" ID="btnCrop" runat="server" OnClick="btnCrop_Click1" Text="Redimensionner" Visible="false" Style="" />
                    ...
                    <tr>
                        ...
                        <td class="auto-style18"> Modules </td>
                    </tr>
                    <tr>
                        <td class="auto-style22">
                        ...
                        <td class="auto-style18"> Watts </td>
                    </tr>
                    <tr>
                        <td class="auto-style22">
